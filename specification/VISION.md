...
3. Whether the README and the player guide stay Ukrainian while the code and specifications are
   English.
**Answered 14 Sep 2026 and closed:** the shipped music was generated by this project's author
(Vitalii), so the Suno account named in the file's C2PA manifest is his and the track meets the
"self-made" half of the media rule. Recorded in `docs/decisions.md` and in
`games/h11v/mods/h11_world/sounds/PROVENANCE.md`; three questions remain open, as above.
